...
class GestionGenresFilms():
    ...
    def hobby_personne_afficher_data (self, valeur_id_personne_selected_dict):
        ...
        try:
            ...
            strsql_film_selected = """SELECT id_personne, nom, prenom, description_film, cover_link_film, date_naissance, GROUP_CONCAT(id_genre) as GenresFilms FROM hobby_personne AS T1
    ...
    def hobby_personne_afficher_data_concat (self, id_personne_selected):
        ...
        try:
            ...
            strsql_hobby_personne_afficher_data_concat = """SELECT id_personne, nom, prenom, description_film, cover_link_film, date_naissance,
