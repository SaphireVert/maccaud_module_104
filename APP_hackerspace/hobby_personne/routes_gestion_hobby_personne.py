...
# ---------------------------------------------------------------------------------------------------
@obj_mon_application.route("/hobby_personne_afficher_concat/<int:id_film_sel>", methods=['GET', 'POST'])
def hobby_personne_afficher_concat (id_film_sel):
    ...
    if request.method == "GET":
        try:
            ...
            data_hobby_personne_afficher_concat = obj_actions_genres.hobby_personne_afficher_data_concat(id_film_sel)
            ...
            if data_hobby_personne_afficher_concat:
                ...
                flash(f"""Le film demandé n'existe pas. Ou la table "t_hobby_personne" est vide. !!""", "warning")
    ...
    if request.method == "GET":
        try:
            ...
            data_genre_film_selected, data_hobby_personne_non_attribues, data_hobby_personne_attribues = \
                obj_actions_genres.hobby_personne_afficher_data(valeur_id_film_selected_dictionnaire)
...
def gf_update_genre_film_selected ():
    if request.method == "POST":
        try:
            ...
            new_lst_int_hobby_personne_old = list(map(int, new_lst_str_hobby_personne))
            print("new_lst_hobby_personne ", new_lst_int_hobby_personne_old, "type new_lst_hobby_personne ",
                  type(new_lst_int_hobby_personne_old))

            # Pour apprécier la facilité de la vie en Python... "les ensembles en Python"
            # https://fr.wikibooks.org/wiki/Programmation_Python/Ensembles
            # OM 2020.04.29 Une liste de "id_genre" qui doivent être effacés de la table intermédiaire "t_hobby_personne".
            lst_diff_genres_delete_b = list(
                set(old_lst_data_hobby_personne_attribues) - set(new_lst_int_hobby_personne_old))
            ...
            lst_diff_genres_insert_a = list(
                set(new_lst_int_hobby_personne_old) - set(old_lst_data_hobby_personne_attribues))
            # DEBUG bon marché : Pour afficher le résultat de la liste.
            ...
            # Pour le film sélectionné, parcourir la liste des genres à INSÉRER dans la "t_hobby_personne".
            ...
            # Pour le film sélectionné, parcourir la liste des genres à EFFACER dans la "t_hobby_personne".
            # Si la liste est vide, la boucle n'est pas parcourue.
            ...
            data_hobby_personne_afficher_concat = obj_actions_genres.hobby_personne_afficher_data_concat(id_film_selected)
            # DEBUG bon marché : Pour afficher le résultat et son type.
            print(" data genres", data_hobby_personne_afficher_concat, "type ", type(data_hobby_personne_afficher_concat))
    ...
    # Après cette mise à jour de la table intermédiaire "t_hobby_personne",
