...
CREATE TABLE `coordonnees` (
  ...
  `adresse` text COMMENT 'Résume du film',
  `cover_link_film` text COMMENT 'lien photo couverture du film',
  `date_naissance` date DEFAULT NULL COMMENT 'date sortie du film'
...
INSERT INTO `coordonnees` (`id_coordonnees`, `telephone`, `mail`, `adresse`, `cover_link_film`, `date_naissance`) VALUES
...
--
ALTER TABLE `coordonnees`
  MODIFY `id_coordonnees` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
