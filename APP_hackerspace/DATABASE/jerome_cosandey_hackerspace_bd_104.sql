...
INSERT INTO `coordonnees` (`id_film`, `nom_film`, `duree_film`, `description_film`, `cover_link_film`, `date_sortie_film`) VALUES
...
ALTER TABLE `t_personne_films`
  ...
  ADD CONSTRAINT `t_personne_films_ibfk_2` FOREIGN KEY (`fk_film`) REFERENCES `coordonnees` (`id_film`);
