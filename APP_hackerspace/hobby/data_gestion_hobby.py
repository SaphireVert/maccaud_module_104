...
class GestionGenres():
    ...
    def add_genre_data (self, valeurs_insertion_dictionnaire):
        try:
            ...
            # OM 2020.04.07 C'EST LA QUE VOUS ALLEZ DEVOIR PLACER VOTRE PROPRE LOGIQUE MySql
            strsql_insert_genre = """INSERT INTO hobby (id_hobby,nom_hobby) VALUES (NULL,%(value_nom_hobby)s)"""
            # Du fait de l'utilisation des "context managers" on accède au curseur grâce au "with".
    ...
    def update_genre_data (self, valeur_update_dictionnaire):
        try:
            ...
            str_sql_update_intitulegenre = "UPDATE hobby SET nom_hobby = %(value_name_genre)s WHERE id_hobby = %(value_id_hobby)s"
    ...
    def delete_select_genre_data (self, valeur_delete_dictionnaire):
        try:
            ...
            str_sql_genres_films_delete = """SELECT id_hobby_personne, nom, prenom, id_hobby, nom_hobby FROM hobby_personne
